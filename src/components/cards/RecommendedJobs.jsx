  ...
  return (
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {/* Visible recommended jobs per breakpoint: 2 / 3 / 5 / 7 */}
        {recommendedJobs.slice(0, 7).map((job, idx) => (
          <div
            key={job.id}
        ...
        >
          ...
          <p className="text-sm text-slate-600">View all recommendations</p>
        </Link>
      </div>
    </div>
  );
